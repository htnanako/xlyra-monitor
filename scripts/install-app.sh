...
ICON_NAME="Sub2APIQuotaIcon"

cd "$ROOT_DIR"
python3 scripts/generate-app-icon.py
iconutil -c icns "Resources/$ICON_NAME.iconset" -o "Resources/$ICON_NAME.icns"
swift build -c release --product Sub2APIQuotaApp

rm -rf "$APP_DIR"
mkdir -p "$APP_DIR/Contents/MacOS" "$APP_DIR/Contents/Resources"
cp "$BUILD_DIR/Sub2APIQuotaApp" "$APP_DIR/Contents/MacOS/Sub2APIQuotaApp"
...
<dict>
    ...
    <string>Sub2APIQuotaIcon</string>
